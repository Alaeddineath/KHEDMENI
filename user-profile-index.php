              ...
              <div class="card-body p-4">
                ...
                <div class="row pt-1">
                  ...
                  <div class="col-6 mb-3">
                    <!-- ratings -->
                    <h6>Rating</h6>
                    <!-- idk how to calculate that tbh -->
                    <p class="text-muted">x/5  </p>
                  </div>
                </div>
                <div class="d-flex justify-content-start">
                <a href="user-edit-profile.php" class="btn btn-light btn-sm">Edit About section</a>

                <form action="user-profile-index.php" method="POST" class="ml-2">
