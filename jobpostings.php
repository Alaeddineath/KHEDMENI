    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
		  ...
		  <li><a class="getstarted scrollto" href="singup.php">sign up</a></li>
        ...
        <?php 
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4 class="title"><a href=""><?php echo htmlspecialchars($job_title); ?></a></h4>
              <p class="description"><?php echo htmlspecialchars($job_description); ?></p>
              <p class="description"><?php echo htmlspecialchars($jobloc); ?></p>
              <p class="description"><?php echo htmlspecialchars($jtype); ?></p>
              <p class="description"><?php echo htmlspecialchars($workertype); ?></p>
            </div>
          </div>
